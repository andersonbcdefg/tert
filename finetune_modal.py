...
def finetune(
    ...
    print("trainable params:", sum(p.numel() for p in classifier.parameters() if p.requires_grad))
    print("trainable params list:", [n for n, p in classifier.named_parameters() if p.requires_grad])
